...
class ProposalRejectionCell(nn.Module):
    ...
    def __init__(self, args, z_what_net, glimpse_dec_net):
        ...
        self.z_pres_anneal_start_value = 1e-10
        self.z_pres_anneal_end_value = 1e-10 # self.args.z_pres_anneal_end_value
        self.z_pres_masked_prior = 1e-10
    ...
    def anneal(self, global_step):
        where_std = np.interp(global_step, [0, 1000, 1500, 30000, 32000], [0.3, 0.3, 0.01, 0.01, 0.15])
